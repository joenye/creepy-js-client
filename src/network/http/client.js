...
const doJson = (url, params = {}) => {
  ...
  const paramsWithDefaults = {
    ...
    body: params.body && typeof params.body !== 'string' ? JSON.stringify(params.body) : undefined,
  };
  ...
  fetch(endpoint, paramsWithDefaults)
    ...
    .then((res) => {
      return params.raw ? res : res.text().then((text) => (text.length ? JSON.parse(text) : null));
    });
};
